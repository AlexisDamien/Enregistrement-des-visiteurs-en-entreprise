 ...
 */
final class Version20230504133308 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE visit ADD COLUMN company VARCHAR(255) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__visit AS SELECT id, encoutered_person_id, reason_id, firstname, lastname, entrance_date, leaving_date, signature FROM visit');
        ...
        $this->addSql('INSERT INTO visit (id, encoutered_person_id, reason_id, firstname, lastname, entrance_date, leaving_date, signature) SELECT id, encoutered_person_id, reason_id, firstname, lastname, entrance_date, leaving_date, signature FROM __temp__visit');
