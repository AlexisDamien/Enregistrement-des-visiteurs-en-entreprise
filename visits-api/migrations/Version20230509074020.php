 ...
 */
final class Version20230509074020 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__visit AS SELECT id, encoutered_person_id, reason_id, firstname, lastname, entrance_date, leaving_date, signature, company FROM visit');
        $this->addSql('DROP TABLE visit');
        $this->addSql('CREATE TABLE visit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, encoutered_person_id INTEGER NOT NULL, reason_id INTEGER NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, entrance_date DATETIME NOT NULL, leaving_date DATETIME DEFAULT NULL, signature BLOB NOT NULL, company VARCHAR(255) NOT NULL, CONSTRAINT FK_437EE93968D83309 FOREIGN KEY (encoutered_person_id) REFERENCES employee (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_437EE93959BB1592 FOREIGN KEY (reason_id) REFERENCES reason (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO visit (id, encoutered_person_id, reason_id, firstname, lastname, entrance_date, leaving_date, signature, company) SELECT id, encoutered_person_id, reason_id, firstname, lastname, entrance_date, leaving_date, signature, company FROM __temp__visit');
